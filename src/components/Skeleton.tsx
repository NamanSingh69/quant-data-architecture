export function Skeleton() {
    return (
        <div className="glass-card p-10 animate-pulse border-brand-500/20 bg-black/40">
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
                <div className="h-24 bg-slate-900/50 rounded-2xl border border-slate-700/50"></div>
                <div className="h-24 bg-slate-900/50 rounded-2xl border border-slate-700/50"></div>
            </div>
        </div>
    );
