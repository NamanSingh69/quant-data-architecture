...
export function EmptyState() {
    return (
        <div className="glass-card p-12 text-center border-dashed border-2 border-slate-700/50 flex flex-col items-center">
            ...
            <h3 className="text-xl font-bold text-slate-300 mb-2">No Active Ingestion</h3>
            <p className="text-slate-500 max-w-sm">
                Initiate a simulated ingestion to process tick streams and populate the data warehouse.
            </p>
        </div>
    );
}
